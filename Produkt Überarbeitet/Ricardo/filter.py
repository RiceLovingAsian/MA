#Liste mit allen Marken welche relevant sind für die Berechnungen 
brands = [
...
"dkw","mercury","pgo","studebaker",'Triumph',"Austin-Healey"]
brands2 = []
#Alle Marken welche falsch oder problematisch geschrieben worden sind, werden umgeschrieben
badguydict = {
